...
public class CallWebServiceRegister extends AsyncTask<String, String, String> {
    ...
    public final static String METHOD_NAME_REGISTER = "register";

    // nome dei parametri
    private static final String PARAMETER_NAME_REG1 = "username";
    private static final String PARAMETER_NAME_REG2 = "password";
    private static final String PARAMETER_NAME_REG3 = "foto";
    ...
    protected String doInBackground(String... params) {
        String SOAP_ACTION = NAMESPACE + METHOD_NAME_REGISTER;

        SoapObject soapObject = new SoapObject(NAMESPACE, METHOD_NAME_REGISTER);
        ...
        soapObject.addProperty(PARAMETER_NAME_REG3, params[3]);   // parametro foto
        ...
        try {
            ...
            for (int i = 0; i < primitive.getPropertyCount(); i++) {
                strIDutente = primitive.getProperty(i).toString();    // Qui il WS returna l'IDutente
                IdUtente = Integer.parseInt(strIDutente);   // Salvo l'idutente nella variabile apposita
            }
            return strIDutente;    // il WS ha risposto e il return viene mandato a onPostExecute
